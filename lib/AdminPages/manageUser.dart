  ...
  ListView generateAllUsersList(QuerySnapshot users){
    ...
    itemBuilder: (context, index) {
      ...
      if(filter == null || filter.isEmpty){
        return showUserTile(name,userType,email,userTypeLong,userColor,userAvatarColor);
      }else if(users.documents[index].data['Name'].toString().toLowerCase().contains(filter.toLowerCase())|| 
        users.documents[index].data['Usertype'].toString().contains(filter) || 
        CommonWidgets.mapUserRoleToLongName(users.documents[index].data['Usertype']).toString().toLowerCase().contains(filter)){
        return showUserTile(name,userType,email,userTypeLong,userColor,userAvatarColor);
      }else{
        return Container();
      }
